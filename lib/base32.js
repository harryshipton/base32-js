...
var defaultAlphabet = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ234567';
 ...
 */
var tables = {};
var lookup = function(alphabet) {
    if(tables[alphabet] != null) {
...
function encode(input, alphabet) {
    return new Encoder(alphabet || defaultAlphabet).update(input, true);
}

// Base32-encoded string goes in, decoded data comes out.
function decode(input, alphabet) {
    try {
        return new Decoder(alphabet || defaultAlphabet).update(input, true);
    }
    catch (e) {
        return '';
    }
